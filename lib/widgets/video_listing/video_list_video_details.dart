...
class VideoListVideoDetails extends StatelessWidget {
  const VideoListVideoDetails(
      {required this.videosList, super.key, required this.scrollController});

  final List<PeopleAlsoViewData> videosList;
                ...
                return GestureDetector(
                  onTap: () async {
                    ...
                    if (!controller.isLoadingData.value &&
                        controller.videoDetails.value!.title != null) {
