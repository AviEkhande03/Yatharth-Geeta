...
class VideosListingWidget extends StatelessWidget {
  const VideosListingWidget({
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          videosList[index].duration,
                                          style:
                                              kTextStylePoppinsLight.copyWith(
                                            fontSize: FontSize
                                                .listingScreenMediaContentCount
                                                .sp,
