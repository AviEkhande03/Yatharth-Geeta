...
class MantraCarousel extends StatefulWidget {
  const MantraCarousel({super.key, required this.mantraList});
  final List<CollectionDatum> mantraList;
  @override
  MantraCarouselState createState() => MantraCarouselState();
}

class MantraCarouselState extends State<MantraCarousel> {
