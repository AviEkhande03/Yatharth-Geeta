...
//
//     final userMediaPlayedVideoViewedModel = userMediaPlayedVideoViewedModelFromJson(jsonString);

import 'dart:convert';

UserMediaPlayedVideoViewedModel userMediaPlayedVideoViewedModelFromJson(
        String str) =>
    UserMediaPlayedVideoViewedModel.fromJson(json.decode(str));

String userMediaPlayedVideoViewedModelToJson(
        UserMediaPlayedVideoViewedModel data) =>
    json.encode(data.toJson());

class UserMediaPlayedVideoViewedModel {
  int? success;
  String? message;
  Data? data;

  UserMediaPlayedVideoViewedModel({
    this.success,
    this.message,
    this.data,
  });

  factory UserMediaPlayedVideoViewedModel.fromJson(Map<String, dynamic> json) =>
      UserMediaPlayedVideoViewedModel(
